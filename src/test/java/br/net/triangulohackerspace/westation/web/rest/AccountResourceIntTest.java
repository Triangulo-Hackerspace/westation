...
import br.net.triangulohackerspace.westation.config.Constants;
import br.net.triangulohackerspace.westation.WestationApp;
import br.net.triangulohackerspace.westation.domain.Authority;
import br.net.triangulohackerspace.westation.domain.User;
import br.net.triangulohackerspace.westation.repository.AuthorityRepository;
import br.net.triangulohackerspace.westation.repository.UserRepository;
import br.net.triangulohackerspace.westation.security.AuthoritiesConstants;
import br.net.triangulohackerspace.westation.service.MailService;
import br.net.triangulohackerspace.westation.service.dto.UserDTO;
import br.net.triangulohackerspace.westation.web.rest.errors.ExceptionTranslator;
import br.net.triangulohackerspace.westation.web.rest.vm.KeyAndPasswordVM;
import br.net.triangulohackerspace.westation.web.rest.vm.ManagedUserVM;
import br.net.triangulohackerspace.westation.service.UserService;
