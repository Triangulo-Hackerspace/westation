package br.net.triangulohackerspace.westation.config.social;

import br.net.triangulohackerspace.westation.repository.SocialUserConnectionRepository;
import br.net.triangulohackerspace.westation.repository.CustomSocialUsersConnectionRepository;
import br.net.triangulohackerspace.westation.security.jwt.TokenProvider;
import br.net.triangulohackerspace.westation.security.social.CustomSignInAdapter;
