package br.net.triangulohackerspace.westation.config;

import br.net.triangulohackerspace.westation.domain.*;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(Station.class.getName(), jcacheConfiguration);
            cm.createCache(Sensor.class.getName(), jcacheConfiguration);
            cm.createCache(Station.class.getName() + ".sensors", jcacheConfiguration);
